...
namespace APlus2
{
    ...
    {
		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Application.dataPath", false, 100)]
		private static void OpenDataPath()
		{
			Reveal(Application.dataPath);
		}

		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Application.persistentDataPath", false, 100)]
        private static void OpenPersistentDataPath()
        {
			Reveal(Application.persistentDataPath);
        }

		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Application.streamingAssetsPath", false, 100)]
		private static void OpenStreamingAssets()
		{
			Reveal(Application.streamingAssetsPath);
		}

		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Application.temporaryCachePath", false, 100)]
		...
		//
		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Asset Store Packages Folder", false, 111)]
		...
		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Editor Application Path")]
		private static void OpenUnityEditorPath()
		{
			Reveal(new FileInfo(EditorApplication.applicationPath).Directory.FullName);
		}
		
		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Editor Log Folder")]
		...
		[MenuItem("Tools/A+ Assets Explorer 2/Quick Folder Opener/Asset Backup Folder", false, 122)]
